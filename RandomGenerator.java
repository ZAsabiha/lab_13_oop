...
public class RandomGenerator {
    ...
    // Sets the destinations for each of the flights from the above destinations randomly
    public String[][] randomDestinations() {
        ...
        return new String[][]{
            {DESTINATIONS[randomCity1][0], DESTINATIONS[randomCity1][1], DESTINATIONS[randomCity1][2]},
            {DESTINATIONS[randomCity2][0], DESTINATIONS[randomCity2][1], DESTINATIONS[randomCity2][2]}
        };
    }
    ...
    public String randomFlightNumbGen(int uptoHowManyLettersRequired, int divisible) {
        String randomAlphabets = generateRandomAlphabets(uptoHowManyLettersRequired);
        return randomAlphabets + "-" + randomNumOfSeats() / divisible;
    }
