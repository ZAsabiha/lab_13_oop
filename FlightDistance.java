public abstract class FlightDistance {
    ...
    private void printHeader(String symbols) {
    ...
    private void printGuidelines() {
        ...
        System.out.println("\t\t2. Actual Distance of the flight may vary from this approximation as Airlines may define their own Travel Policy that may restrict the planes to fly through specific regions...\n");
