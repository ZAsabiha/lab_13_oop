...
public class User {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (desiredOption) {
                case 1:
                    initializeDefaultAdminCredentials();
                    loginAsAdmin(r1, c1, bookingAndReserving, f1, read, read1);
                    break;
                case 2:
                    registerAsAdmin(r1, countNumOfUsers, read1);
                    countNumOfUsers++;
                    break;
                case 3:
                    loginAsPassenger(r1, c1, bookingAndReserving, f1, read, read1);
                    break;
                case 4:
                    c1.addNewCustomer();
                    break;
    ...
    static void initializeDefaultAdminCredentials() {
        adminUserNameAndPassword[0][0] = "root";
        adminUserNameAndPassword[0][1] = "root";
    }

    static void loginAsAdmin(RolesAndPermissions r1, Customer c1, FlightReservation bookingAndReserving, Flight f1, Scanner read, Scanner read1) {
        ...
        if (r1.isPrivilegedUserOrNot(username, password) == -1) {
            ...
            System.out.printf(
                    ...
                    "", username);
            displayAdminMenu(r1, c1, bookingAndReserving, f1, read, read1, username);
        }
    }

    static void registerAsAdmin(RolesAndPermissions r1, int countNumOfUsers, Scanner read1) {
    ...
    static void loginAsPassenger(RolesAndPermissions r1, Customer c1, FlightReservation bookingAndReserving, Flight f1, Scanner read, Scanner read1) {
        ...
        if (Integer.parseInt(result[0]) == 1) {
            ...
            System.out.printf(
                    "\n\n%-20sLogged in Successfully as \"%s\"..... For further Proceedings, enter a value from below....",
                    "", userName);
            displayPassengerMenu(r1, c1, bookingAndReserving, f1, read, read1, result);
        } else {
            System.out.printf(
                    "\n%20sERROR!!! Unable to login Cannot find user with the entered credentials.... Try Creating New Credentials or get yourself register by pressing 4....\n",
                    "");
    ...
    static void displayUserManual() {
        ...
        if (choice == 1) {
            ...
            displayUserManualDetails();
        }
    }

    static void displayAdminMenu(RolesAndPermissions r1, Customer c1, FlightReservation bookingAndReserving, Flight f1, Scanner read, Scanner read1, String username) {
        int desiredOption;
        do {
            ...
            desiredOption = read.nextInt();
            handleAdminMenuChoice(desiredOption, c1, bookingAndReserving, f1, read, read1, username);
        } while (desiredOption != 0);
    }

    static void displayPassengerMenu(RolesAndPermissions r1, Customer c1, FlightReservation bookingAndReserving, Flight f1, Scanner read, Scanner read1, String[] result) {
        int desiredChoice;
        do {
            ...
            handlePassengerMenuChoice(desiredChoice, c1, bookingAndReserving, f1, read, read1, result);
        } while (desiredChoice != 0);
    }

    static void handleAdminMenuChoice(int desiredOption, Customer c1, FlightReservation bookingAndReserving, Flight f1, Scanner read, Scanner read1, String username) {
        switch (desiredOption) {
            case 1:
                c1.addNewCustomer();
                break;
    ...
    static void handlePassengerMenuChoice(int desiredChoice, Customer c1, FlightReservation bookingAndReserving, Flight f1, Scanner read, Scanner read1, String[] result) {
        switch (desiredChoice) {
            ...
            case 3:
                ...
                if (confirmationChar == 'Y' || confirmationChar == 'y') {
                    ...
                    System.out.printf("User %s's account deleted Successfully...!!!", result[1]);
                    desiredChoice = 0;
                } else {
    ...
    static void displayUserManualDetails() {
        System.out.println(
        ...
        System.out
                .println("(9) Pressing \"4\"// filepath: c:\Users\Farhan\Downloads\AirlineReservationSystem1\AirlineReservationSystem\src\User.java
import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;
